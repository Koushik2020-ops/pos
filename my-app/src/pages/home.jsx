       ...
       <div className="min-h-screen bg-base-200">
            <div className="container mx-auto py-10">
                ...
                <div className="flex flex-wrap justify-center gap-6">
                    ...
                    <button className="btn btn-secondary w-48">Add Product</button>
                    <button className="btn btn-accent w-48">View Inventory</button>
                    <button className="btn btn-info w-48">Generate Report</button>
                </div>
            </div>
        </div>
    </>
