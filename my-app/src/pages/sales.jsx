...
function Sale() {
    ...
    const handleAddItem = (e) => {
        ...
        if (formData.name && formData.quantity && formData.price) {
            ...
            setFormData({ name: "", quantity: "", price: "" }); // Reset form fields
        } else {
                    ...
                    {items.length > 0 ? (
                        <>
                            ...
                            <div className="flex justify-between items-center mt-4">
                                <h3 className="text-lg font-bold">Total Amount: ${calculateTotal()}</h3>
                ...
                <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center">
                    <div className=" p-6 rounded shadow-lg max-w-2xl w-full">
                        ...
                        <div id="popup-content">
                            ...
                            <h3 className="text-right font-bold mt-4">Total Amount: ${calculateTotal()}</h3>
                        </div>
